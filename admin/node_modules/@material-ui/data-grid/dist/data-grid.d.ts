...
interface GridColDef {
     ...
     * @param params
     */
    renderCell?: (params: GridCellParams) => React$1.ReactElement;
    /**
     * Allows to override the component rendered in edit cell mode for this column.
     * @param params
     */
    renderEditCell?: (params: GridCellParams) => React$1.ReactElement;
    /**
     ...
     * @param params
     */
    renderHeader?: (params: GridColumnHeaderParams) => React$1.ReactElement;
    /**
 ...
 * The full grid API.
 */
interface GridApi extends GridCoreApi, GridComponentsApi, GridStateApi, GridDensityApi, GridEventsApi, GridRowApi, GridEditRowApi, GridParamsApi, GridColumnApi, GridSelectionApi, GridSortApi, GridVirtualizationApi, GridPaginationApi, GridCsvExportApi, GridFocusApi, GridFilterApi, ColumnMenuApi, PreferencesPanelApi, LocaleTextApi {
}
...
declare const useGridFilter: (apiRef: GridApiRef, rowsProp: readonly GridRowData[]) => void;
...
declare const gridKeyboardStateSelector: (state: GridState) => GridKeyboardState;
declare const gridKeyboardMultipleKeySelector: reselect.OutputSelector<GridState, boolean, (res: GridKeyboardState) => boolean>;

declare const useGridKeyboard: (gridRootRef: React$1.RefObject<HTMLDivElement>, apiRef: GridApiRef) => void;

declare const useGridKeyboardNavigation: (gridRootRef: React$1.RefObject<HTMLDivElement>, apiRef: GridApiRef) => void;
...
declare const useGridRows: (apiRef: GridApiRef, rows: readonly GridRowData[], getRowIdProp?: GridRowIdGetter | undefined) => void;
...
declare const useGridSorting: (apiRef: GridApiRef, rowsProp: readonly GridRowData[]) => void;
...
declare const useGridVirtualRows: (colRef: React$1.MutableRefObject<HTMLDivElement | null>, windowRef: React$1.MutableRefObject<HTMLDivElement | null>, renderingZoneRef: React$1.MutableRefObject<HTMLDivElement | null>, apiRef: GridApiRef) => void;
...
declare const useGridColumnResize: (columnsRef: React$1.RefObject<HTMLDivElement>, apiRef: GridApiRef) => void;
...
declare function useApi(gridRootRef: React$1.RefObject<HTMLDivElement>, columnHeadersContainerRef: React$1.RefObject<HTMLDivElement>, apiRef: GridApiRef): boolean;
...
declare const useGridContainerProps: (windowRef: React$1.RefObject<HTMLDivElement>, apiRef: GridApiRef) => void;
...
declare const isMultipleKeyPressed: (event: any) => any;
...
declare type DataGridProps = Omit<GridComponentProps, 'disableColumnResize' | 'disableColumnReorder' | 'disableMultipleColumnsFiltering' | 'disableMultipleColumnsSorting' | 'disableMultipleSelection' | 'licenseStatus' | 'apiRef' | 'options' | 'pagination' | 'onRowsScrollEnd' | 'scrollEndThreshold'> & {
...
declare const DataGrid: React$1.MemoExoticComponent<React$1.ForwardRefExoticComponent<Omit<GridComponentProps, "disableColumnReorder" | "disableColumnResize" | "disableMultipleColumnsFiltering" | "disableMultipleSelection" | "disableMultipleColumnsSorting" | "onRowsScrollEnd" | "pagination" | "scrollEndThreshold" | "apiRef" | "licenseStatus" | "options"> & {
...
export { AutoSizerProps, AutoSizerSize, CursorCoordinates, DEFAULT_GRID_COL_TYPE_KEY, DEFAULT_GRID_OPTIONS, DEFAULT_GRID_SLOTS_COMPONENTS, DEFAULT_GRID_SLOTS_ICONS, DataGrid, DataGridProps, ElementSize, FilterColumnLookup, GRID_BOOLEAN_COLUMN_TYPE, GRID_CELL_BLUR, GRID_CELL_CLICK, GRID_CELL_CSS_CLASS, GRID_CELL_CSS_CLASS_SUFFIX, GRID_CELL_DOUBLE_CLICK, GRID_CELL_DRAG_END, GRID_CELL_DRAG_ENTER, GRID_CELL_DRAG_OVER, GRID_CELL_DRAG_START, GRID_CELL_EDIT_COMMIT_KEYS, GRID_CELL_EDIT_ENTER, GRID_CELL_EDIT_EXIT, GRID_CELL_EDIT_PROPS_CHANGE, GRID_CELL_EDIT_PROPS_CHANGE_COMMITTED, GRID_CELL_ENTER, GRID_CELL_EXIT_EDIT_MODE_KEYS, GRID_CELL_FOCUS, GRID_CELL_KEYDOWN, GRID_CELL_LEAVE, GRID_CELL_MODE_CHANGE, GRID_CELL_MOUSE_DOWN, GRID_CELL_NAVIGATION_KEYDOWN, GRID_CELL_OUT, GRID_CELL_OVER, GRID_CELL_VALUE_CHANGE, GRID_COLUMNS_UPDATED, GRID_COLUMN_HEADER_BLUR, GRID_COLUMN_HEADER_CLICK, GRID_COLUMN_HEADER_CSS_CLASS, GRID_COLUMN_HEADER_CSS_CLASS_SUFFIX, GRID_COLUMN_HEADER_DOUBLE_CLICK, GRID_COLUMN_HEADER_DRAGGING_CSS_CLASS, GRID_COLUMN_HEADER_DRAG_END, GRID_COLUMN_HEADER_DRAG_ENTER, GRID_COLUMN_HEADER_DRAG_OVER, GRID_COLUMN_HEADER_DRAG_START, GRID_COLUMN_HEADER_DROP_ZONE_CSS_CLASS, GRID_COLUMN_HEADER_ENTER, GRID_COLUMN_HEADER_FOCUS, GRID_COLUMN_HEADER_KEYDOWN, GRID_COLUMN_HEADER_LEAVE, GRID_COLUMN_HEADER_NAVIGATION_KEYDOWN, GRID_COLUMN_HEADER_OUT, GRID_COLUMN_HEADER_OVER, GRID_COLUMN_HEADER_SEPARATOR_RESIZABLE_CSS_CLASS, GRID_COLUMN_HEADER_TITLE_CSS_CLASS, GRID_COLUMN_ORDER_CHANGE, GRID_COLUMN_RESIZE, GRID_COLUMN_RESIZE_COMMITTED, GRID_COLUMN_RESIZE_START, GRID_COLUMN_RESIZE_STOP, GRID_COLUMN_SEPARATOR_MOUSE_DOWN, GRID_COLUMN_VISIBILITY_CHANGE, GRID_COMPONENT_ERROR, GRID_CSS_CLASS_PREFIX, GRID_DATA_CONTAINER_CSS_CLASS, GRID_DATETIME_COLUMN_TYPE, GRID_DATETIME_COL_DEF, GRID_DATE_COLUMN_TYPE, GRID_DATE_COL_DEF, GRID_DEFAULT_LOCALE_TEXT, GRID_ELEMENT_FOCUS_OUT, GRID_EXPERIMENTAL_ENABLED, GRID_FILTER_MODEL_CHANGE, GRID_FOCUS_OUT, GRID_KEYDOWN, GRID_KEYUP, GRID_MULTIPLE_SELECTION_KEYS, GRID_NATIVE_SCROLL, GRID_NUMBER_COLUMN_TYPE, GRID_NUMERIC_COL_DEF, GRID_PAGESIZE_CHANGED, GRID_PAGE_CHANGED, GRID_RESIZE, GRID_ROOT_CSS_CLASS_SUFFIX, GRID_ROWS_CLEARED, GRID_ROWS_SCROLL, GRID_ROWS_SCROLL_END, GRID_ROWS_SET, GRID_ROWS_UPDATED, GRID_ROW_CLICK, GRID_ROW_CSS_CLASS, GRID_ROW_CSS_CLASS_SUFFIX, GRID_ROW_DOUBLE_CLICK, GRID_ROW_EDIT_MODEL_CHANGE, GRID_ROW_ENTER, GRID_ROW_LEAVE, GRID_ROW_OUT, GRID_ROW_OVER, GRID_ROW_SELECTED, GRID_SELECTION_CHANGED, GRID_SORT_MODEL_CHANGE, GRID_STATE_CHANGE, GRID_STRING_COLUMN_TYPE, GRID_STRING_COL_DEF, GRID_UNMOUNT, GridAddIcon, GridAlignment, GridApi, GridApiContext, GridApiRef, GridApiRefComponentsProperty, GridArrowDownwardIcon, GridArrowUpwardIcon, GridAutoSizer, GridCell, GridCellCheckboxForwardRef, GridCellCheckboxRenderer, GridCellClassFn, GridCellClassNamePropType, GridCellClassParams, GridCellClassRules, GridCellIdentifier, GridCellIndexCoordinates, GridCellMode, GridCellModeChangeParams, GridCellParams, GridCellProps, GridCellValue, GridCheckCircleIcon, GridCheckIcon, GridClasses, GridCloseIcon, GridColDef, GridColType, GridColTypeDef, GridColumnApi, GridColumnHeaderIndexCoordinates, GridColumnHeaderItem, GridColumnHeaderMenu, GridColumnHeaderMenuProps, GridColumnHeaderParams, GridColumnHeaderSeparator, GridColumnHeaderSeparatorProps, GridColumnHeaderSortIcon, GridColumnHeaderSortIconProps, GridColumnHeaderTitle, GridColumnHeaderTitleProps, GridColumnHeadersItemCollection, GridColumnHeadersItemCollectionProps, GridColumnIcon, GridColumnIdentifier, GridColumnLookup, GridColumnMenu, GridColumnMenuContainer, GridColumnMenuProps, GridColumnMenuState, GridColumnOrderChangeParams, GridColumnProp, GridColumnReorderState, GridColumnResizeParams, GridColumnResizeState, GridColumnTypesRecord, GridColumns, GridColumnsContainer, GridColumnsHeader, GridColumnsMenuItem, GridColumnsMeta, GridColumnsPanel, GridColumnsToolbarButton, GridComparatorFn, GridComponent, GridComponentProps, GridComponentsApi, GridContainerProps, GridCoreApi, GridCsvExportApi, GridDataContainer, GridDensity, GridDensityApi, GridDensityOption, GridDensitySelector, GridDensityTypes, GridDragIcon, GridEditCellProps, GridEditCellPropsParams, GridEditCellValueParams, GridEditInputCell, GridEditRowApi, GridEditRowModelParams, GridEditRowProps, GridEditRowsModel, GridEmptyCell, GridEmptyCellProps, GridEventsApi, GridExportFormat, GridExportOption, GridFeatureMode, GridFeatureModeConstant, GridFieldComparatorList, GridFilterAltIcon, GridFilterForm, GridFilterFormProps, GridFilterInputValue, GridFilterInputValueProps, GridFilterItem, GridFilterItemProps, GridFilterListIcon, GridFilterMenuItem, GridFilterModel, GridFilterModelParams, GridFilterModelState, GridFilterOperator, GridFilterPanel, GridFilterToolbarButton, GridFocusState, GridFooter, GridFooterContainer, GridFooterContainerProps, GridHeader, GridHeaderCheckbox, GridIconSlotsComponent, GridInternalColumns, GridKeyboardState, GridLinkOperator, GridLoadIcon, GridLoadingOverlay, GridLocaleText, GridMenu, GridMenuIcon, GridMenuProps, GridNativeColTypes, GridNoRowsOverlay, GridOptions, GridOptionsProp, GridOverlay, GridOverlayProps, GridPageChangeParams, GridPagination, GridPaginationApi, GridPaginationState, GridPanel, GridPanelContent, GridPanelFooter, GridPanelHeader, GridPanelProps, GridPanelWrapper, GridParamsApi, GridPreferencePanelState, GridPreferencePanelsValue, GridPreferencesPanel, GridRenderColumnsProps, GridRenderContextProps, GridRenderPaginationProps, GridRenderRowProps, GridRenderingZone, GridResizeParams, GridRoot, GridRootContainerRef, GridRootProps, GridRow, GridRowApi, GridRowCells, GridRowCount, GridRowData, GridRowId, GridRowIdGetter, GridRowModel, GridRowModelUpdate, GridRowParams, GridRowProps, GridRowScrollEndParams, GridRowSelectedParams, GridRowsLookup, GridRowsProp, GridSaveAltIcon, GridScrollArea, GridScrollBarState, GridScrollFn, GridScrollParams, GridSearchIcon, GridSelectedRowCount, GridSelectionApi, GridSelectionModelChangeParams, GridSelectionState, GridSeparatorIcon, GridSlotComponentProps, GridSlotsComponent, GridSlotsComponentsProps, GridSortApi, GridSortCellParams, GridSortColumnLookup, GridSortDirection, GridSortItem, GridSortModel, GridSortModelParams, GridSortingState, GridState, GridStateApi, GridStateChangeParams, GridStickyContainer, GridTabIndexState, GridTableRowsIcon, GridToolbar, GridToolbarContainer, GridToolbarContainerProps, GridToolbarExport, GridTranslationKeys, GridTripleDotsVerticalIcon, GridTypeFilterInputValueProps, GridUpdateAction, GridValueFormatterParams, GridValueGetterParams, GridViewHeadlineIcon, GridViewStreamIcon, GridViewport, GridViewportSizeState, GridVirtualizationApi, GridWindow, GridWindowProps, HideGridColMenuItem, InternalGridRowsState, InternalRenderingState, LocaleTextApi, Localization, LocalizationV4, LocalizationV5, Logger, Optional, SUBMIT_FILTER_STROKE_TIME, SortGridMenuItems, VisibleGridRowsState, Watermark, WatermarkProps, activeGridFilterItemsSelector, allGridColumnsFieldsSelector, allGridColumnsSelector, bgBG, checkGridRowIdIsValid, composeClasses, convertGridRowsPropToState, createTheme, deDE, elGR, enUS, esES, exportAs, filterGridColumnLookupSelector, filterGridItemsCounterSelector, filterGridStateSelector, filterableGridColumnsIdsSelector, filterableGridColumnsSelector, findGridCellElementsFromCol, findGridDataContainerFromCurrent, findGridRootFromCurrent, findHeaderElementFromField, findParentElementFromClassName, formatDateToLocalInputDate, frFR, generateUtilityClass, getDataGridUtilityClass, getFieldFromHeaderElem, getGridCellElement, getGridCellElementFromIndexes, getGridColDef, getGridColumnHeaderElement, getGridDateOperators, getGridDefaultColumnTypes, getGridLocalization, getGridNumericColumnOperators, getGridRowElement, getGridStringOperators, getIdFromRowElem, getInitialGridColumnReorderState, getInitialGridColumnResizeState, getInitialGridColumnsState, getInitialGridFilterState, getInitialGridRenderingState, getInitialGridRowState, getInitialGridSortingState, getInitialGridState, getInitialVisibleGridRowsState, getRowEl, getScrollbarSize, getThemePaletteMode, gridCheckboxSelectionColDef, gridColumnLookupSelector, gridColumnMenuStateSelector, gridColumnReorderDragColSelector, gridColumnReorderSelector, gridColumnResizeSelector, gridColumnsMetaSelector, gridColumnsSelector, gridColumnsTotalWidthSelector, gridDateComparer, gridDateFormatter, gridDateTimeFormatter, gridEditRowsStateSelector, gridFocusCellSelector, gridFocusColumnHeaderSelector, gridFocusStateSelector, gridKeyboardMultipleKeySelector, gridKeyboardStateSelector, gridNillComparer, gridNumberComparer, gridPaginationSelector, gridPreferencePanelStateSelector, gridResizingColumnFieldSelector, gridRowCountSelector, gridRowsLookupSelector, gridRowsStateSelector, gridScrollbarStateSelector, gridSelectionStateSelector, gridSortColumnLookupSelector, gridSortModelSelector, gridStringNumberComparer, gridTabIndexCellSelector, gridTabIndexColumnHeaderSelector, gridTabIndexStateSelector, gridViewportSizeStateSelector, isArrowKeys, isCellEditCommitKeys, isCellEnterEditModeKeys, isCellExitEditModeKeys, isDate, isDateValid, isDeepEqual, isDeleteKeys, isDesc, isEnterKey, isEscapeKey, isFunction, isGridCellRoot, isGridHeaderCellRoot, isGridHeaderTitleContainer, isHideMenuKey, isHomeOrEndKeys, isKeyboardEvent, isMuiV5, isMultipleKey, isMultipleKeyPressed, isNavigationKey, isNumber, isObject, isOverflown, isPageKeys, isPrintableKey, isSpaceKey, isTabKey, itIT, jaJP, localStorageAvailable, mapColDefTypeToInputType, mergeGridColTypes, mergeGridOptions, muiStyleAlpha, nextGridSortDirection, nlNL, parseDate, parseDateTime, plPL, plPLGrid, ptBR, removeUndefinedProps, renderEditInputCell, ruRU, ruRUGrid, selectedGridRowsCountSelector, selectedGridRowsSelector, skSK, skSKGrid, sortedGridRowIdsSelector, sortedGridRowsSelector, trTR, ukUA, ukUAGrid, unorderedGridRowIdsSelector, unorderedGridRowModelsSelector, useApi, useEnhancedEffect, useEventCallback, useGridApi, useGridApiEventHandler, useGridApiMethod, useGridApiOptionHandler, useGridApiRef, useGridColumnMenu, useGridColumnReorder, useGridColumnResize, useGridColumns, useGridComponents, useGridContainerProps, useGridEditRows, useGridFilter, useGridFocus, useGridKeyboard, useGridKeyboardNavigation, useGridPagination, useGridParamsApi, useGridPreferencesPanel, useGridReducer, useGridRows, useGridScrollFn, useGridSelection, useGridSelector, useGridSlotComponentProps, useGridSorting, useGridState, useGridVirtualColumns, useGridVirtualRows, useLogger, useLoggerFactory, useNativeEventListener, useThemeProps, visibleGridColumnsLengthSelector, visibleGridColumnsSelector, visibleGridRowCountSelector, visibleGridRowsStateSelector, visibleSortedGridRowIdsSelector, visibleSortedGridRowsAsArraySelector, visibleSortedGridRowsSelector };
